...
const Grow = () => {
  ...
  return (
    <Wrapper>
      <div className="container mx-auto px-6 md:px-16 md:flex md:flex-row md:justify-between md:items-center mt-2 md:mt-8">
        <div className="md:w-1/2">
          <h1 className="text-[25px] font-bold md:leading-12 md:text-4xl">
            Accelerate Your Product, Strengthen Your Systems, Scale With Confidence
          </h1>
          <p className='text-sm mt-4 leading-6 md:leading-8'>
      ...
      <div className='flex flex-col gap-4 items-center mt-8'>
        ...
        <div className='md:w-[500px]'>
          <h1 className='text-[22px] md:text-[35px] text-center'>We help you scale with structure, not guesswork.</h1>
        ...
        <div className="flex justify-center gap-4 mt-10">
          {testimonials.map((user, index) => (
            <Image
              ...
              className={`rounded-full cursor-pointer ${index === current ? "scale-110 border-2 border-white" : "opacity-50"
                }`}
            />
          ))}
        </div>

        <div className="relative w-full md:max-w-3xl mx-auto mt-12 text-center">

          <button onClick={prevSlide} className="absolute left-0 top-1/2 -translate-y-1/2 border rounded-full p-1.5 md:p-3">
            <ArrowLeft />
          </button>
<div className="px-3">
          <p className="text-sm md:text-lg px-6">
            “{testimonials[current].text}”
          </p>

          <h3 className="mt-3 md:mt-8 text-xl font-semibold">
          ...
          <button onClick={nextSlide} className="absolute right-0 top-1/2 -translate-y-1/2 border rounded-full p-1.5 md:p-3">
            <ArrowRight />
          </button>
      ...
      <div className="flex flex-col items-center mt-8">
        <h1 className="text-md md:text-4xl text-center mb-4 underline font-bold"> Your Product Deserves More Than Advice, <br /> Let’s fix what’s not working </h1>
