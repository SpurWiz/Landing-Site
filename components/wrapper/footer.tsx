      ...
      <div className="container mx-auto px-6 py-12 grid md:grid-cols-4 gap-8">
        ...
        <div className="space-y-2">
          ...
          <div className="flex space-x-3">
            ...
            <Link href="#"><img src="/icons/instagram.png" alt="Instagram" className="w-7 h-7"/></Link>
            <Link href="#"><img src="/icons/facebook.png" alt="Facebook" className="w-7 h-7"/></Link>
            <Link href="#"><img src="/icons/x.png" alt="X" className="w-7 h-7"/></Link>
            <Link href="#"><img src="/icons/linkedin.png" alt="LinkedIn" className="w-7 h-7"/></Link>
            <Link href="#"><img src="/icons/tiktok.png" alt="TikTok" className="w-7 h-7"/></Link>
          </div>
          <div>
